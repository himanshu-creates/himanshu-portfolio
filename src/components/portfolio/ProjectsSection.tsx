    ...
    <div className="max-w-6xl mx-auto">
      ...
      <TiltCard>
        <motion.div
          ...
          className="glass-card-hover rounded-2xl overflow-hidden mb-10"
        >
          <div className="md:flex">
            ...
            <div className="md:w-2/5 p-8 flex flex-col justify-center">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                A UI/UX concept platform presenting community stories and traditions
                through a simple and engaging interface.
              </p>

              <a
                href="https://www.figma.com/site/yCoX3TNlx9dcNFcPFoSMXS/LOKVANI?node-id=0-1"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-primary text-white hover:opacity-90 transition"
              >
        ...
        >
          ...
          <div className="md:flex flex-row-reverse">
            ...
            <div className="md:w-1/2 p-8 flex flex-col justify-center">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Designed the UI/UX for a healthcare website during a hackathon,
                focusing on clean layout, intuitive navigation, and clear
                information hierarchy so users can quickly access medical
